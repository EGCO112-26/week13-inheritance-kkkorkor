...
public:
    student(long=111 ,double=2.5,string="Nattawut",long=521142);
    ~student();
    void display(); // display_person
   
};

student::student(long i, double g,string s,long nid):MU_person(i,s,nid){ //ส่งข้อมูลให้ MU_person (id, name)
